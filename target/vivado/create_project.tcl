...
#
# Generated by Vivado on Mon Jul 13 08:02:36 CEST 2026
...
#
#    "/home/kagandikmen/Desktop/V-FRONT/rtl/soc/bram_dual.v"
#    "/home/kagandikmen/Desktop/V-FRONT/rtl/cpu/cpu.v"
#    "/home/kagandikmen/Desktop/V-FRONT/rtl/soc/soc.v"
#    "/home/kagandikmen/Desktop/V-FRONT/target/vivado/const.xdc"
#    "/home/kagandikmen/Desktop/V-FRONT/rtl/soc/soc_tb.v"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../rtl/soc/bram_dual.v"]"\
 "[file normalize "$origin_dir/../../rtl/cpu/cpu.v"]"\
 "[file normalize "$origin_dir/../../rtl/soc/soc.v"]"\
 "[file normalize "$origin_dir/const.xdc"]"\
 "[file normalize "$origin_dir/../../rtl/soc/soc_tb.v"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/../../build/vivado"]"
...
# Create project
create_project ${_xil_proj_name_} $orig_proj_dir -part xc7a100tcsg324-1
...
set file "$origin_dir/../../rtl/soc/bram_dual.v"
...
set file "$origin_dir/../../rtl/cpu/cpu.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../../rtl/soc/soc.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set_property -name "include_dirs" -value "[file normalize "$origin_dir/../../rtl/cpu"] [file normalize "$origin_dir/../../rtl/cpu/luftALU/rtl"] [file normalize "$origin_dir/../../rtl/cpu/luftALU/rtl/subunits"] [file normalize "$origin_dir/../../lib"]" -objects $obj
...
set file "[file normalize "$origin_dir/const.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/const.xdc"
set file [file normalize $file]
...
set file "$origin_dir/../../rtl/soc/soc_tb.v"
set file [file normalize $file]
...
set_property -name "generic" -value "MEM_INIT_FILE=\"$origin_dir/../../sim/init.mem\"" -objects $obj
...
set_property -name "verilog_uppercase" -value "0" -objects $obj
set_property -name "vhdl_define" -value "" -objects $obj
set_property -name "vhdl_generic" -value "MEM_INIT_FILE=\"$origin_dir/../../sim/init.mem\"" -objects $obj
