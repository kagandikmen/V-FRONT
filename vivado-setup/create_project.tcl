...
#
# Generated by Vivado on Sat May 24 19:52:43 CEST 2025
...
set files [list \
 ...
 [file normalize "${origin_dir}/../sim/pmem.hex"] \
 [file normalize "${origin_dir}/../sim/dmem.hex"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/../sim/pmem.hex"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Unknown" -objects $file_obj

set file "$origin_dir/../sim/dmem.hex"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Unknown" -objects $file_obj
